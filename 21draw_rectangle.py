...
def main():
    ...
    path_txt = '/home/jc/pycharm-2017.2.3/PycharmProjects/demoDetect/毕设/txt/mtcnn_cacia_1stageNoDetect.txt'
    path_txt_sub = '/home/jc/pycharm-2017.2.3/PycharmProjects/demoDetect/毕设/txt/mtcnn_cacia_1stageNoDetect_sub.txt'
    if (not os.path.exists(path_txt)) or (not os.path.exists(path_txt_sub)):
        exit()
    f = open(path_txt, 'a+')
    ...
    img=cv2.imread('/home/jc/图片/人脸/20180210121118607_1.jpg')
    img_matlab = img.copy()
    # img_matlab = img.copy()
    # tmp = img_matlab[:, :, 2].copy()
    # img_matlab[:, :, 2] = img_matlab[:, :, 0]
    ...
    # cv2.imshow('im',img_matlab)
    # cv2.waitKey(0)
    # cv2.imwrite('/home/jc/图片/人脸/20180210121118607_1_c.jpg',img_matlab)
    # srcPoints_c=srcPoints
    # srcPoints_c=srcPoints_c.tolist()
    # for i in srcPoints:
    #     cv2.circle(img,i,3,(0,255,0,3))
    # cv2.imshow('img',img)
    # cv2.waitKey(0)
    ...
    if len(boundingboxes) == 0:
        ...
        srcPoints_l=[[points[0][0], points[0][5]], [points[0][1], points[0][6]],
             [points[0][2], points[0][7]],
             [points[0][3], points[0][8]], [points[0][4], points[0][9]]]
        ...
        for i in srcPoints:
            print i
            cv2.circle(img_matlab, (i[0],i[1]), 3, (0, 255, 0),-1)
        drawBoxes(img_matlab, boundingboxes)
        cv2.imshow('img', img_matlab)
        cv2.waitKey(0)
        cv2.imwrite('/home/jc/图片/人脸/20180210121118607_1_cc.jpg',img_matlab)
